...
public:
	...
	consensus.nSubsidyHalvingInterval = 77787420;
        ...
        consensus.nPowTargetTimespan = 1 * 1 * 139 * 60; // 139 minutes
        consensus.nPowTargetSpacing = 1 * 60; // 1 minute
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 104; // 75% of 139
        consensus.nMinerConfirmationWindow = 139; // nPowTargetTimespan / nPowTargetSpacing
