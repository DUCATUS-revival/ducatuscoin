...
public:
	...
	consensus.nSubsidyHalvingInterval = 77787420;
        ...
        consensus.nPowTargetTimespan = 1 * 1 * 11 * 60; // 16 minutes
        consensus.nPowTargetSpacing = 1 * 60; // 1 minute
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 8; // 73% of 11
        consensus.nMinerConfirmationWindow = 11; // nPowTargetTimespan / nPowTargetSpacing
